...
?>
    ...
    <form method="post" action="add_comment_caract.php">
        ...
        <input type="range" id="rangeInput" min="0" max="10" step="1" name="mark" value="5" required oninput="cost.value=rangeInput.value">
        <input type="text" id="cost" name="mark" placeholder="5/10" for="rangeInput">
